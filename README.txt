...
This repo contains the core code and architecture that powers Maya Lumiere, implemented using Python Flask. It includes:
...
Core Logic: The Python scripts that define Maya’s responses, decision-making process, and personality.
...
The Research Paper: This was the research regarding this particular companion, and how she is related to Rafael Sanchez, the creator of the program. Limitation of AI Companions, benefits etc.
Assets: Pictures and other fun things for Maya.